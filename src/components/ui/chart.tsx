...
// Format: { COLOR_NAME: CSS_VARIABLE }
...
function getPayloadConfigFromPayload(
  ...
  if (
    ...
    for (const [payloadKey, configKey] of [
      ["fill", "color"],
      ["dataKey", "key"],
    ]) {
      if (payloadKey in payloadPayload && typeof payloadPayload[payloadKey as keyof typeof payloadPayload] === "string") {
        const value = payloadPayload[payloadKey as keyof typeof payloadPayload] as string
        if (value in config) {
